	...
	return (
		<div className="flex items-center justify-between gap-4 p-3 rounded-lg border border-border/50 hover:border-border transition-colors">
			...
			<Switch
				style={
					{
						'--switch-checked-bg': 'var(--color-source-spotify)',
			...
			>
				<DialogContent>
					<DialogHeader>
						...
						<DialogDescription>
							We’ll automatically track your listening time for your target
							language.
						</DialogDescription>
					</DialogHeader>
			...
			>
				<DialogContent>
					<DialogHeader>
						...
						<DialogDescription>
							This will stop auto-tracking from Spotify. You can re-enable it
							anytime.
						</DialogDescription>
					</DialogHeader>
					<DialogFooter>

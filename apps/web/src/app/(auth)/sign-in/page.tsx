...
export default function SignInPage() {
    ...
    const form = useForm<{ email: string; password: string; }>({
        ...
        onSubmit: async () => {
            setErrorMessage("Email/password sign-in is no longer supported. Please use Google or Discord.");
        },
    });
                        ...
                        <div className="flex flex-col gap-4 px-6 pb-6">
                                    ...
                                    try {
                                        ...
                                        try {
                                            if (typeof window !== "undefined") {
                                                ...
                                                window.localStorage.setItem("lastAuthProvider", "discord");
                            ...
                            >
                                {lastUsedProvider === "discord" && (
                                    <Badge variant="dark" className="absolute -top-2 -right-2">Last used</Badge>
                                )}

...
export default function Combobox({ value, setValue }: { value: string, setValue: (value: string) => void; }) {
    ...
    return (
        <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
                ...
                >
                    {value ? options.find(opt => opt.value === value)?.label || value : "Select timezone..."}
                    <ChevronsUpDown />
                </Button>
            </PopoverTrigger>
                            ...
                            {options.map((option) => (
                                <CommandItem
                                    ...
                                    onSelect={(currentValue) => {
                                        ...
                                        const selectedOption = options.find(opt => opt.searchText === currentValue);
                                        if (selectedOption) {

        ...
        <>
            <div>
                <div className="snbex:flex snbex:items-center snbex:gap-2 snbex:mb-2">
                    ...
                    <div className="snbex:text-lg snbex:font-bold">Tracking stopped</div>
                </div>
                ...
                <div className="snbex:text-sm snbex:font-medium snbex:text-background snbex:mb-4">
                    We stopped tracking your time on <span className="snbex:font-bold">{domain}</span>
                </div>
                <Button className="snbex:w-full snbex:mt-3 snbex:bg-foreground snbex:text-background" onClick={defaultTrackAnyway}>
                    Track anyway
                </Button>
            </div>
            {renderDebugInfo?.()}

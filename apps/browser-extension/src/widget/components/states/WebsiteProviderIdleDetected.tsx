            ...
            <div >
                <div className="snbex:flex snbex:items-center snbex:gap-2 snbex:mb-2">
                    ...
                    <div className="snbex:flex snbex:flex-col snbex:items-start snbex:text-lg snbex:font-bold">
                        {/* LANGUAGE NAME */}<span>{languageCodeToLabel(userInfo.languageCode)} detected!</span>
                        <span className='snbex:text-sm snbex:font-medium snbex:text-background snbex:mb-2'>Want to track your time on this site?</span>
                    </div>
                </div>
                ...
                <div className="snbex:flex snbex:gap-2">
                    <Button variant="neutral" className='snbex:flex-1' onClick={defaultDontTrack}>Dont Track</Button>
                    <Button className='snbex:flex-1 snbex:bg-accent' variant={"neutral"} onClick={defaultOpenAlwaysTrackQuestion}>Track This!</Button>
                </div>
            </div>
            {renderDebugInfo?.()}
        </>

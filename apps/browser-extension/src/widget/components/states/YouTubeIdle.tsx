...
interface YouTubeIdleProps {
    widgetState: WidgetState;
    renderDebugInfo?: () => React.ReactNode;
}

export const YouTubeIdle: React.FC<YouTubeIdleProps> = ({
    widgetState,
    renderDebugInfo,
}) => {
    return (
        <>
            <div className="snbex:mt-3 snbex:text-center">
                <div className="snbex:flex snbex:items-center snbex:justify-center snbex:gap-2 snbex:mb-2">
                    <svg
                        className="snbex:w-5 snbex:h-5 snbex:text-red-600"
                        viewBox="0 0 24 24"
                        fill="currentColor"
